...
namespace AniDrag.EventBus.Utils
{
    ...
    /// <list type="bullet">
    ///   <item><description><b>Discovery</b> – scans all runtime assemblies to find every type that implements <see cref="IEvent"/>,
    ...
    {
        /// <summary>
        /// A read?only list of all discovered event types (types that implement <see cref="IEvent"/>).
        ...
        public static void Initialize()
        {
            ...
            EventTypes = PreDefinedAssemlyUtil.GetTypes(typeof(IEvent));
